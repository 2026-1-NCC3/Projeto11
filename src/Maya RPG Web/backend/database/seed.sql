...
INSERT INTO prescricoes (paciente_id, exercicio_id, series, repeticoes, duracao_seg, frequencia, observacoes, criado_por) VALUES
  ...
  ('f0000000-0000-0000-0000-000000000001', 'e0000000-0000-0000-0000-000000000007', 3, 12, NULL, '5x por semana', 'Foco na contração glútea', 'b0000000-0000-0000-0000-000000000001'),
  ('f0000000-0000-0000-0000-000000000001', 'e0000000-0000-0000-0000-000000000004', 1, 1, 120, 'Diário', 'Antes de dormir', 'b0000000-0000-0000-0000-000000000001'),

  -- Ana (cervical): trapézio + gato-vaca + rotação torácica + escapular
  ('f0000000-0000-0000-0000-000000000002', 'e0000000-0000-0000-0000-000000000006', 3, 1, 30, 'Diário', 'A cada 2h no trabalho', 'b0000000-0000-0000-0000-000000000001'),
  ('f0000000-0000-0000-0000-000000000002', 'e0000000-0000-0000-0000-000000000003', 2, 10, NULL, 'Diário', 'Movimento lento e controlado', 'b0000000-0000-0000-0000-000000000001'),
  ...
  ('f0000000-0000-0000-0000-000000000003', 'e0000000-0000-0000-0000-000000000005', 1, 1, 600, '3x por semana', 'Supervisão na clínica', 'b0000000-0000-0000-0000-000000000001'),
  ...
  ('f0000000-0000-0000-0000-000000000003', 'e0000000-0000-0000-0000-000000000001', 3, 1, 30, 'Diário', NULL, 'b0000000-0000-0000-0000-000000000001'),
  ('f0000000-0000-0000-0000-000000000003', 'e0000000-0000-0000-0000-000000000004', 1, 1, 120, 'Diário', 'Antes de dormir', 'b0000000-0000-0000-0000-000000000001'),

  -- Paciente de teste (paciente@maya.com): cadeia posterior + prancha + gato-vaca + respiração + trapézio
  ('f0000000-0000-0000-0000-000000000004', 'e0000000-0000-0000-0000-000000000001', 3, 1, 30, '3x por semana', 'Manter 30s cada lado', 'b0000000-0000-0000-0000-000000000001'),
  ('f0000000-0000-0000-0000-000000000004', 'e0000000-0000-0000-0000-000000000002', 3, 1, 30, '3x por semana', 'Começar com 30s, progredir para 60s', 'b0000000-0000-0000-0000-000000000001'),
  ('f0000000-0000-0000-0000-000000000004', 'e0000000-0000-0000-0000-000000000003', 2, 10, NULL, 'Diário', 'Movimento lento e controlado', 'b0000000-0000-0000-0000-000000000001'),
  ('f0000000-0000-0000-0000-000000000004', 'e0000000-0000-0000-0000-000000000004', 1, 1, 120, 'Diário', 'Pela manhã ao acordar', 'b0000000-0000-0000-0000-000000000001'),
  ('f0000000-0000-0000-0000-000000000004', 'e0000000-0000-0000-0000-000000000006', 3, 1, 30, 'Diário', 'A cada 2h de trabalho', 'b0000000-0000-0000-0000-000000000001')
ON CONFLICT DO NOTHING;
